...
public class Click : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        check_start = false;
        back.SetActive(true);
        text_pause_high.text = "최고 점수: " + Scenemove.Hhh.high_click.ToString();
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (point > Scenemove.Hhh.high_click) Scenemove.Hhh.high_click = point;
            text_end_hihg_point.text = "최고점수: " + Scenemove.Hhh.high_click.ToString();
            Scenemove.Hhh.Save();
            End.SetActive(true);
        }
        ...
        if(Input.touchCount >= 1)
        {
            ...
            {
                if (Input.GetTouch(i).phase == TouchPhase.Began) pointupdown(1);
            }
        }
