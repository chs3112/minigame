...
public class Time_click : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        check_start = false;
        back.SetActive(true);
        text_pause_high.text = "최고 시간: " + Scenemove.Hhh.high_time.ToString("F2");
    ...
    public void Time_out()
    {
        ...
        if (time_now > Scenemove.Hhh.high_time) Scenemove.Hhh.high_time = time_now;
        text_end_hihg_point.text = "최고시간: " + Scenemove.Hhh.high_time.ToString("F2");
        Scenemove.Hhh.Save();
        End.SetActive(true);
    }
    ...
    void Update()
    {
        ...
        if (time_now < 5) text_time.text = time_now.ToString("F2");
        else
        {
            check_start = false;
            text_time.text = "5.00";
