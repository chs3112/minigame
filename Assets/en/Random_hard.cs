...
public class Random_hard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        check_start = false;
        back.SetActive(true);
        text_pause_high.text = "최고 점수: " + Scenemove.Hhh.high_random_hard.ToString();
    ...
    void Game_End()
    {
        ...
        if (point > Scenemove.Hhh.high_random_hard) Scenemove.Hhh.high_random_hard = point;
        text_end_hihg_point.text = "최고점수: " + Scenemove.Hhh.high_random_hard.ToString();
        Scenemove.Hhh.Save();
        End.SetActive(true);
    }
