...
public class Name_color : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        check_start = false;
        back.SetActive(true);
        text_pause_high.text = "최고 시간: " + Scenemove.Hhh.high_name.ToString("F2");
    ...
    void Game_End()
    {
        ...
        if (time_now < Scenemove.Hhh.high_name) Scenemove.Hhh.high_name = time_now;
        else if (Scenemove.Hhh.high_name == 0) Scenemove.Hhh.high_name = time_now;
        text_end_hihg_point.text = "최고시간: " + Scenemove.Hhh.high_name.ToString("F2");
        Scenemove.Hhh.Save();
        End.SetActive(true);
    }
